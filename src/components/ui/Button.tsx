...
export default function Button({
  ...
  const variants = {
    primary: "color-card-warm hover:bg-[#ffb347] text-cream border border-wood-dark shadow-sm",
    secondary: "bg-white hover:bg-[#EAEFF7] text-wood-light border border-wood-light/30 shadow-xs",
